const Home = ({ ...props }) => (
  ...
  >
    ...
    <path d="M0 13.317s.826 1.524 2.631 0l10.781-9.121 10.107 9.064c2.088 1.506 2.871 0 2.871 0L13.412 1.504 0 13.317zM23.273 4.175h-2.599l.011 3.153 2.588 2.197z" />
  </svg>
);

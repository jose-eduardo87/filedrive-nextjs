...
// I started implementing file deletion: when DELETE response was ok, I wanted the
...
// it somehow worked, the said "solution" bled my eyes everytime I had to look to the
